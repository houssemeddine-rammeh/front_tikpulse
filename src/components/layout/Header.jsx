...
const Header = () => {
  ...
  const getUserDisplayName = () => {
    ...
    return user.username || user.name || user.email || t('common.user');
  ...
  const mainNavItems = [
...

    {
      ...
      title: t('pages.creators.profile'),
  ...
  const adminNavItems = [

    {
      ...
      title: t('navigation.manageManagers'),
...
{isTablet ? "" : t('common.home')}
            ...
            {(user.role === UserRole.MANAGER ||
              ...
              <Tooltip title={t('navigation.events')}>
...
{isTablet ? "" : t('navigation.events')}
            ...
            {(user.role === UserRole.MANAGER ||
              ...
              <Tooltip title={t('navigation.creators')}>
...
{isTablet ? "" : t('navigation.creators')}
            ...
            {user.role === UserRole.CREATOR && (
              ...
              <Tooltip title={t('navigation.wiki')}>
...
{isTablet ? "" : t('navigation.wiki')}
            ...
            {(user.role === UserRole.MANAGER ||
              ...
              <Tooltip title={t('navigation.contact')}>
        ...
        >
          ...
          >
            ...
            <ListItemText>
              ...
              <Typography variant="body2">{t('header.profileSettings')}</Typography>
            ...
            <>
              ...
              >
                ...
                <ListItemText>
                  ...
                  <Typography variant="body2">{t('header.managerDashboard')}</Typography>
                ...
                <ListItemText>
                  ...
                  <Typography variant="body2">
                    ...
                    {user?.role === UserRole.MANAGER
                      ...
                      ? t('userRoles.myCreators')

                      : t('userRoles.assignedCreators')}
          ...
          {/* Mobile-only theme toggle and language switcher */}
...
{user?.role === UserRole.ADMIN ? t('userRoles.allCreators') : t('userRoles.myCreators')}
            ...
            >
              ...
              {/* topCreators.length */} {t('header.activeCreators')}
